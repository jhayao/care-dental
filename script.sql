...
(
    ...
    down_payment     decimal(10, 2)              default 0.00 null,
    installment_months int                       default 0 null,
...
(
    ...
    status           enum ('pending', 'confirmed', 'cancelled', 'rescheduled', 'refunded', 'completed', 'rejected', 'failed') default 'pending' null,
...
(
    ...
    due_date          date                                                                                          null,
    installment_number int                                                                                          default 0 null,
