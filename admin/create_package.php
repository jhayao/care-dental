...
<div class="flex-1 p-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold flex items-center">
            <i class="fas fa-box-open mr-2 text-blue-600"></i> Create Package
        </h1>
        <a href="package.php" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600 flex items-center">
    ...
    <div class="bg-white shadow-lg rounded-lg p-6 max-w-3xl mx-auto">
        <form action="add_package.php" method="POST">
            <div class="mb-4">
                ...
                <input type="text" name="package_name" class="w-full border px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            </div>

            <div class="mb-4">
                <label class="block mb-1 font-semibold">Description</label>
                <textarea name="description" class="w-full border px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" rows="3" required></textarea>
            </div>
            ...
            <div class="flex justify-end gap-2">
                <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 font-semibold transition">Save Package</button>
            </div>
        </form>
    </div>
</div>
