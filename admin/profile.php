...
$stmt = $conn->prepare("SELECT id, first_name, last_name, address_, email, gender, created_at FROM users WHERE id=? AND user_type='admin' LIMIT 1");
...
<div id="editProfileModal" class="fixed inset-0 bg-black bg-opacity-50 hidden justify-center items-center z-50">
    <div class="bg-white rounded-lg shadow-lg w-96 p-6 relative">
        ...
        <form action="update_admin_profile.php" method="POST" class="space-y-4">
