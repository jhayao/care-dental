...
<div class="flex-1 p-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold flex items-center">
            <i class="fas fa-edit mr-2 text-blue-600"></i> Edit Service
        </h1>
    ...
    <div class="bg-white shadow-lg rounded-lg p-6 max-w-2xl mx-auto">
        <form action="update_service.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="service_name" value="<?= htmlspecialchars($service['service_name']) ?>" class="w-full border px-3 py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            </div>
            ...
            <div class="mb-6">
                ...
                <?php if (!empty($service['service_image'])): ?>
                    <div class="mb-2">
                        <img src="../<?= htmlspecialchars($service['service_image']) ?>" alt="Current Image" class="w-32 h-32 object-cover rounded border">
                    </div>
                <?php endif; ?>
            ...
            <div class="flex justify-end gap-2">
                <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 font-semibold transition">Update Service</button>
            </div>
        </form>
    </div>
</div>
